...
<script charset="UTF-8">
  ...
  {
    category: "카페",
    image: "image/제휴 업체/프루미에 케이크/1.png",
    title: "프루미에 케이크",
    description: `미니케이크 1000원 할인
1호, 2호 케이크 2000원 할인
네이버 영수증 리뷰 작성 시 디자인초 제공`,
    subImage1: "image/제휴 업체/프루미에 케이크/2.png",
    subImage2: "image/제휴 업체/프루미에 케이크/3.png",
    location: null,
    discount: null,
    mapCodeModal: `<!-- * 카카오맵 - 지도퍼가기 -->
<!-- 1. 지도 노드 -->
<div id="daumRoughmapContainer1772982802334" class="root_daum_roughmap root_daum_roughmap_landing"></div>
