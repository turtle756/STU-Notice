...

{
    ...
    title: "엘피스",
    description: "엘피스는 기독교정신을 바탕으로 예수 그리스도의 사랑과 실천으로 공동체를 이루며 그 시대의문화에 맞춰 어느 곳에서든지 복음을 전하는 데 목적을 두고 있습니다! 주된 활동은 학교 채플과 신앙수련회 찬양팀 방중사역 (수련회, 고교채플) 등이 있습니다!인스타그램) @_elpeace_페이스북) 하나님의 소망, 엘피스 문화찬양선교단전체리더 고민빈 010.9552.8018",
    kakaoLink: null, // 카카오톡 오픈채팅 링크 (가입 문의용)
    detail: null
