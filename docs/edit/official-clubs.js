...
const officialClubsData = [
  ...
  // @@@@@@@@@@@@@@@@@
  {
    ...
    subImage1: "docs/image/정규동아리/엘피스/엘피스 2.png", // 서브 이미지 1 (없으면 null)
    ...
    detail: "엘피스는 서울신학대학교 소속 찬양선교동아리입니다.\n 매주 정기 연습과 합주를 통해 예배를 준비하며,\n학기 중 채플 찬양 인도와 각종 교내외 행사에서 활발히 활동하고 있습니다.", // 모달 팝업에 표시될 상세 설명
    kakaoLink: null, // 카카오톡 오픈채팅 링크 (없으면 null)
