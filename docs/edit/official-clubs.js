...
const officialClubsData = [
  // @@@@@@@@@@@@@@@@@
  {
    ...
    image: "https://github.com/turtle756/STU-Notice/blob/main/docs/image/%EC%A6%9D%EC%9D%B8%EB%93%A4%203.png", // 대표 이미지 경로
  ...
  {
    category: "종교", // 카테고리 필터용 (officialClubsConfig.categories 중 하나)
    image: "https://github.com/turtle756/STU-Notice/blob/main/docs/image/%EC%97%98%ED%94%BC%EC%8A%A4%201.jpg", // 대표 이미지 경로
    subImage1: null, // 서브 이미지 1 (없으면 null)
    subImage2: null, // 서브 이미지 2 (없으면 null)
    title: "엘피스",
