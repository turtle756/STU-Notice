...
const eventsData = [
  // @@@@@@@@@@@@@@@@@
  {
    ...
    image: "image/2024가을축제/가을축제.png", // 카드 이미지 경로
    title: "2024 가을 축제",
  ...
  // @@@@@@@@@@@@@@@@@
  {
    ...
    image: "image/창업아이디어공모전/창업공모전.png", // 카드 이미지 경로
    title: "창업 아이디어 공모전",
  ...
  {
    category: "행사", // 카테고리 필터용 (eventsConfig.categories 중 하나)
    image: "image/겨울MT/겨울MT.png", // 카드 이미지 경로
    title: "겨울 MT",
  ...
  {
    category: "공모전", // 카테고리 필터용 (eventsConfig.categories 중 하나)
    image: "image/글쓰기경진대회/글쓰기대회.png", // 카드 이미지 경로
    title: "글쓰기 경진대회",
  ...
  {
    category: "행사", // 카테고리 필터용 (eventsConfig.categories 중 하나)
    image: "image/체육대회/체육대회.png", // 카드 이미지 경로
    title: "체육대회",
